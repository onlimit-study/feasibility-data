...
class Center(Enum):
    ...
    Aarhus = APIConfig(env_key="REDCAP_AAR_API_KEY", url="https://redcap.auh.dk/api/")
    Copenhagen = APIConfig(
        env_key="REDCAP_CPH_API_KEY", url="https://redcap.regionh.dk/api/"
    )
    Odense = APIConfig(env_key="REDCAP_ODN_API_KEY", url="https://redcap.sdu.dk/api/")
    Test = APIConfig(env_key="REDCAP_TEST_API_KEY", url="https://redcap.au.dk/api/")

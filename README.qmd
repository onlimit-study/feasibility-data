...
This repository contains the data package for the feasibility phase of the [ON
LiMiT](https://onlimit.org/) study. The data package includes both the metadata and
the data. The metadata is publicly accessible from this repository while the
data is stored on the [GenomeDK](https://genome.au.dk) server at [Aarhus

...
<!-- [![GitHub
License](https://img.shields.io/github/license/onlimit-study/feasibility-data.svg)](https://github.com/onlimit-study/feasibility-data/blob/main/LICENSE.md) -->
[![GitHub
Release](https://img.shields.io/github/v/release/onlimit-study/feasibility-data.svg)](https://github.com/onlimit-study/feasibility-data/releases/latest)
[![Checks](https://github.com/onlimit-study/feasibility-data/actions/workflows/checks.yml/badge.svg)](https://github.com/onlimit-study/feasibility-data/actions/workflows/checks.yml)
[![Build
website](https://github.com/onlimit-study/feasibility-data/actions/workflows/build-website.yml/badge.svg)](https://github.com/onlimit-study/feasibility-data/actions/workflows/build-website.yml)
[![pre-commit.ci
status](https://results.pre-commit.ci/badge/github/onlimit-study/feasibility-data/main.svg)](https://results.pre-commit.ci/latest/github/onlimit-study/feasibility-data/main)
